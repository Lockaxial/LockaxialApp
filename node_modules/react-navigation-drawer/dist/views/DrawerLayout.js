...
export default class DrawerLayout extends Component {
  ...
  render() {
    ...
    return <PanGestureHandler hitSlop={hitSlop} minOffsetX={gestureOrientation * minSwipeDistance} maxDeltaY={15} onGestureEvent={this._onGestureEvent} onHandlerStateChange={this._openingHandlerStateChange} ref={this.props.gestureRef}>
        {this._renderDrawer()}
      </PanGestureHandler>;
  }
}
