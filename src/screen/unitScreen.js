...
export default class UnitScreen extends NormalScreen {
  ...
  *打开房屋详情页面
  */
  openUnitDetailScreen(rowID){
    var item=accountDao.unitList[rowID];
    this.openScreen('UnitDetailScreen',{item:item});
  }
        ...
        <List containerStyle={MainStyle.list}>
          <ListView
            ...
            renderRow={(item, sectionID, rowID) =>
                    <ListItem onPress={()=>this.openUnitDetailScreen(rowID)} key={rowID}
                      title={item.unitName}
